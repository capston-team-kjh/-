// INLINED TYPES TO FIX BUILD ERRORS
export type FocusState = "focus" | "gaze_side" | "gaze_down" | "drowsy";
export type HybridState = FocusState | "absent" | "bad_posture" | "page_turn" | "pen_fidget" | "restless_hand" | "unknown";
export type OverheadActivity = "page_turn" | "pen_fidget" | "restless_hand";

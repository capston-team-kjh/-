...
const checklistItems = [
  ...
  { title: "얼굴 캠과 책상 캠이 올바르게 연결됐어요", detail: "두 화면이 반대로 보인다면 카메라 역할을 바꿔주세요." },
];
...
const faqs = [
  ...
  },
  {
    ...
    answer: "학습 화면의 ‘역할 전환’ 버튼으로 얼굴용·책상용 카메라를 바꿀 수 있습니다. 바꾼 뒤에는 ‘얼굴 캠’에 얼굴이, ‘책상 캠’에 책상 위 학습 영역이 나오는지 다시 확인해주세요.",
  },
  {
    ...
    <div className={`fg-root fg-guide ${className}`}>
      <div className="fg-container">
        ...
        <section className="fg-section" aria-labelledby={sectionId("cameras")}>
          ...
          <p className="fg-note"><strong>두 화면이 반대로 보이나요?</strong> 학습 화면의 ‘역할 전환’ 버튼으로 얼굴 캠과 책상 캠을 바꾼 뒤 다시 확인해주세요.</p>
        </section>
